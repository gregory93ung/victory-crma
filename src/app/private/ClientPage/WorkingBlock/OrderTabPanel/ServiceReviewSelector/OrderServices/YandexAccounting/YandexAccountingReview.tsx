...
import { ResYandexAccountingReviewModal } from '@/components/modals/res-yandex-accounting-review-modal';

type YandexAccountingReviewProps = {
  review: Clients.YandexAccountingReview;
  firmUrl: string;
  orderId: number;
  serviceId: number;
};

export const YandexAccountingReview = ({
  review,
  firmUrl,
  orderId,
  serviceId,
}: YandexAccountingReviewProps) => {
  return (
    <ResYandexAccountingReviewModal
      reviewInfo={review}
      firmUrl={firmUrl}
      orderId={orderId}
      serviceId={serviceId}
