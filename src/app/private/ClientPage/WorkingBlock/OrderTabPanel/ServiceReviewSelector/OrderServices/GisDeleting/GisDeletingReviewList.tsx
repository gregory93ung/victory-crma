...
import { GisDeletingReview } from './GisDeletingReview';

type GisDeletingReviewListProps = {
  orderId: number;
  serviceId: number;
  firmUrl: string;
};

export const GisDeletingReviewList = ({
  orderId,
  firmUrl,
  serviceId,
}: GisDeletingReviewListProps) => {
