...
import { RespGisDeletingReviewModal } from '@/components/modals/resp-gis-deleting-review-modal';

type GisDeletingReviewProps = {
  review: Clients.GisDeletingReview;
  firmUrl: string;
  orderId: number;
  serviceId: number;
};
...
export const GisDeletingReview = ({
  review,
  firmUrl,
  orderId,
  serviceId,
}: GisDeletingReviewProps) => {
  return (
    <RespGisDeletingReviewModal
      reviewInfo={review}
      firmUrl={firmUrl}
      orderId={orderId}
      serviceId={serviceId}
